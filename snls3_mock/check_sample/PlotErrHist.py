...
def gethist(outfig_name=None):
	...
	# plt.hist(dmu, bins=nbin_all, label=r'ALL')
	# plt.hist(dmu[ID1], bins=nbin_1, label=r'$z < 0.3$')
	# plt.hist(dmu[ID2], bins=nbin_2, label=r'$z >= 0.8$')

	# plt.hist(dmu, bins=nbin_all, histtype='barstacked',label=r'ALL')
	# plt.hist(dmu[ID1], bins=nbin_1, histtype='barstacked', label=r'$z < 0.3$')
	# plt.hist(dmu[ID2], bins=nbin_2, histtype='barstacked', label=r'$z >= 0.8$')
